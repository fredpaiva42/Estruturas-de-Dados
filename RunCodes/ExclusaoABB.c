...
//
//    if (chave < raiz -> chave) // se a chave for menor que a raiz, então o elemento da sub-árvore esquerda é excluido
//        raiz -> esq = exclui(raiz -> esq, chave);
//    else if (chave > raiz -> chave) // se a chave for maior que a raiz, então o elemento da sub-árvore direita é excluido
//        raiz -> dir = exclui(raiz -> dir, chave);
//    else {
//        if (raiz -> esq == NULL  && raiz -> dir == NULL) { // se é nó folha
//            free(raiz);
//            raiz = NULL;
//        }
//        else if (raiz -> esq == NULL || raiz -> dir == NULL){ // nó tem apenas um sucessor
//            TNoA *aux = raiz;
//            if (raiz -> esq) raiz = raiz -> esq;
//            else raiz = raiz -> dir;
//            free(aux);
//        }
//        else { // nó tem dois sucessores
//            TNoA *sucessor = raiz -> esq;
//            while(sucessor -> dir){
